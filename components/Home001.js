...
const Home001 = () => {
    ...
    return (
        <div
            className="relative min-h-[300px] md:h-[600px] max-h-[600px] w-full overflow-hidden"
            id="home"
            style={{
        ...
        >
            <div className="container mx-auto h-full px-4">
                <div className="flex flex-col md:flex-row h-full items-center justify-between gap-8">
                    ...
                    <ScrollAnimationWrapper className="order-2 md:order-1 w-full md:w-1/2">
                        <motion.div
                    ...
                    <ScrollAnimationWrapper className="order-1 md:order-2 w-full md:w-1/2">
                        <motion.div
                            className="text-center md:text-left"
                            variants={scrollAnimation}
                        >
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white-500">
                               Regala Momentos <span className="text-yellow-500">Mágicos</span>
                            </h1>
